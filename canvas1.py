...
# canvas1.py демонстрация основных возможностей холста
...
photo=PhotoImage(file='v.gif')
canvas.create_image(325, 25, image=photo, anchor=NW) # встроить изображение

lbl = Label(canvas, text='Spam', fg="white", bg="black")
lbl.pack()
canvas.create_window(100, 100, window=lbl) # встроить виджет
